...
<meta charset="UTF-8">
	...
	<script type="text/javascript">
		$(function () {
			...
			// newRecord("작성자", "게시판 제목", "게시판 내용", "첨부파일.jpg", "첨부파일.jpg", "2020-00-00", 0);
			listData();
		...
		function listData(){
			...
			$.getJSON("/gallery/galleryData.do", function(data){
				...
				$(data).each(function(index){
					...
					newRecord(g_name, g_subject, g_content, g_thumb, g_file, g_date, index);
				});
			}).fail(function() {
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="galleryModalLabel">
						갤러리 등록</h4>
					</div>
					<div class="modal-body">
						<form id="f_writeForm" name="f_writeForm">
							<div class="form-group">
								...
								id="g_name" maxlength="5"/>
							</div>
							<div class="form-group">
								<label for="g_subject" class="control-label">글 제목</label>
								<input type="text" class="form-control" name="g_subject" 
								id="g_subject" maxlength="50"/>
							</div>
							<div class="form-group">
								<label for="g_content" class="control-label">글 내용</label>
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" name="g_pwd" 
								id="g_pwd"/>
							</div>
						</form>
					</div>
