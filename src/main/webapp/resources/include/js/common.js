/**
 * 함수명 : chkSubmit(유효성 체크 대상, 메세지 내용) 출력영역:alert으로. 예시
 * id(!chkSubmit($(#keyword)."검색어를") return;
 */
...
/*
 * 함수명 : checkForm(유효성 체크 대상, 메세지 내용) 출력영역 : placeholder 속성을 이용. 예시 :
...
/*
 * 함수명 : formCheck(유효성 체크 대상, 출력 영역, 메세지 내용) 출력영역 : 매개변수 두번째 출력영역에. 예시 :
 * if(!chkSubmit($('#keyword'),"검색어를")) return;
 */
...
/*
 * 함수명 : chkData(유효성 체크 대상, 메세지 내용) 예시 : if(!chkData("#keyword","검색어를")) return;
 */
...
/*
 * 함수명 : chkFile(파일명) 설명 : 이미지 파일 여부를 확인하기 위해 확장자확인 함수.
 */
