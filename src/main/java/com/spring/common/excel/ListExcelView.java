...
public class ListExcelView extends AbstractXlsView {
	...
	/*
	 * 참고 : "Content-disposition : attachment"은 브라우저 인식 파일 확장자를 포함하여 모든 확장자의 파일들에
	 * 대해, 다운로드시 무조건 "파일다운로드" 대화상자를 보여주도록 헤더 속성이라 할 수 있다
	 */
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		/*
		 * 참고: jXLS은 액셀파일 포맷의 템플릿을 이용하여 엑셀 파일을 손쉽게 생성하기 위한 패키지 (jXLS은 탬플릿을 기반으로 최종 엑셀파일을
		 * 생성)
		 */
